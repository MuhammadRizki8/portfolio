...
function Home() {
  return (
    <div className="text-white h-screen flex flex-col w-full bg-gradient-to-b from-[#09132e] to-[#0b1a45]" id="home">
      <div className="h-screen flex items-center md:w-10/12 w-11/12 mx-auto">
        <div className="flex justify-between items-center m-auto">
          <div className="sm:w-7/12 w-10/12 max-[495px]:w-11/12 sm:mx-0 mx-auto animate-fadeIn">
            ...
            <div className="w-fit pt-3 flex items-center gap-2">
              <img src={locationIcon} className="object-contain w-5 h-5" alt="Location Icon" />
            ...
            <div className="flex items-center xl:w-1/2 lg:w-4/6 sm:w-11/12 w-3/4 max-[555px]:w-10/12 max-[495px]:w-11/12 max-[445px]:w-full justify-between pt-6">
              <a href={resume} target="_blank" rel="noreferrer">
                <ButtonWithImage icon={resize} activeIcon={resizeActive} label="Resume" className="hover:shadow-lg transition-shadow duration-300" />
              </a>
              <a href="#contact">
                <ButtonWithImage icon={contact} activeIcon={contactActive} label="Contact Me" className="hover:shadow-lg transition-shadow duration-300" />
              </a>
            </div>
          </div>
          <div className="sm:w-1/3 sm:block hidden animate-slideIn">
            <img className="object-contain" src={icon} alt="Personal Icon" />
          </div>
        </div>
      </div>
    </div>
